...
const cardData = new Map([
    ...
    ['contact', {
        ...
        <div className="card-data-contact" style={{textAlign: 'left'}}>
            ...
            <div className="contact-block">
                <h3>Linkedin: </h3>
                <a href="www.linkedin.com/in/evan-mclay-3642a0106" target="_blank" className="body-text">www.linkedin.com/in/evan-mclay-3642a0106</a>
            </div>
            <div className="contact-block">
                <h3>Github: </h3>
                <a href="https://github.com/Distant-Skyline-Xtal" target="_blank" className="body-text">https://github.com/Distant-Skyline-Xtal</a>
            </div>
        </div>
        )
    }],
